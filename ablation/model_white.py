...
class SpectralSBUNet(nn.Module):
    def __init__(self, seg_len=512, base_channels=64, channel_mults=(1, 2, 4, 8), num_res_blocks=2, t_emb_dim=128, num_groups=8, dropout=0.0, sqrt_h_path="ablation/ablation_spectral_h/white_spectral_h.npy"):
        super().__init__()
